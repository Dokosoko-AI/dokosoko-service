  ...
  return (
    <span
      ...
      className={clsx([
        className,
        // Basic layout
        'core-control-shell group relative block w-full',
    ...
    >
      <Headless.Select
        ...
        className={clsx([
          // Basic layout
          'core-select relative block w-full appearance-none rounded-lg py-[calc(--spacing(2.5)-1px)] sm:py-[calc(--spacing(1.5)-1px)]',
          // Horizontal padding
          multiple
          ...
          // Typography
          'type-body text-zinc-950 placeholder:text-zinc-500 dark:text-white dark:*:text-white',
          // Border
