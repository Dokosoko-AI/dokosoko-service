...
export function ConsoleLink({ path, onNavigate, className, children, ariaCurrent, ariaLabel }: { path: string; onNavigate: (path: string) => void; className?: string; children: ReactNode; ariaCurrent?: "page"; ariaLabel?: string }) {
...
export function EntityLink({ entity, uid, onNavigate, className, children }: { entity: EntityKind; uid: string; onNavigate: (path: string) => void; className?: string; children: ReactNode }) {
