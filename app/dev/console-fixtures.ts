...
export const fixtureDeployment: APIDeployment = { id: "prod_acme", organisation_id: "org_acme", name: "Acme Platform", slug: "acme", description: "Documentation, exact SDK references, runtime credentials, recipes, and reviewed tools through one MCP connector.", catalog_revision: 12, public_mcp_enabled: false, revision: 1 };
