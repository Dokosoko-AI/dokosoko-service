...
type Store interface {
	...
	ReportingConfig(context.Context, string) (model.ReportingConfig, error)
	SaveReportingConfig(context.Context, model.ReportingConfig, int64) (model.ReportingConfig, error)
	ReportSubmissions(context.Context, string, int) ([]model.ReportSubmission, error)
	...
	ActivateHeldReportSubmissions(context.Context, string, string, time.Time) error
